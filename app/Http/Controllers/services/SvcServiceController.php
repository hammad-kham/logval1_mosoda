    ...
    {	
		...
		{	
            $request->validate([
                ...
                'small_price' => 'required',
                'medium_price' => 'required',
                'large_price' => 'required',
            ...
            $Model_Data->small_price = $request->small_price;
            $Model_Data->medium_price = $request->medium_price;
            $Model_Data->large_price = $request->large_price;
